...
contract Ownable {
    ...
    function getOwner() public returns (
                                    address
                                    ) {
        return _owner;
    }
    ...
    constructor (
        ...
        _owner = msg.sender;
                 emit OwnershipWasTransfered(_owner);
    ...
    event OwnershipWasTransfered(address theNewOwner);
...
//  2) create a public setter using the inherited onlyOwner modifier 
 function pausedSetter(bool pauseValue) public onlyOwner {
        _paused =     pauseValue;
    }
...
modifier whenNotPaused() {
        require(_paused == false, "currently Paused");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        // TODO require the given address to not be the owner of the tokenId
                require(to != _tokenOwner[tokenId] , "the given address is the owner of the tokenId") ;
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
                require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId], msg.sender) , "requires the msg sender to be the owner of the contract or isApprovedForAll() to be true");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId) , "not the owner of the given token" );
        // TODO: require token is being transfered to valid address
        require(to != address(0x0),"not valid to address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    // TODO: create external getter functions for name, symbol, and baseTokenURI
     ...
     function symbol() public returns (
                                     string memory
                                    ) {
        return _symbol;
    }
    ...
    // as per https://docs.opensea.io/docs/1-structuring-your-smart-contract
     function baseTokenURI() public returns (
                                      string memory
                                    ) {
        return _baseTokenURI;
    }
...
contract  meshalContract is ERC721Metadata ("meshalContract", "MC","https://udacity.meshal.io/token/"){
