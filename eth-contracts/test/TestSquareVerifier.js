...
it('proof is incorrect', async function () { 
    ...
    let v = await this.contract.verifyTx.call(wrongProof.proof.A,
        wrongProof.proof.A_p,
        wrongProof.proof.B,
        wrongProof.proof.B_p,
        wrongProof.proof.C,
        wrongProof.proof.C_p,
        wrongProof.proof.H,
        wrongProof.proof.K,
        wrongProof.input,
        {from: account_one}
      );
      assert.equal(v, false, " valid proof");
}) 
